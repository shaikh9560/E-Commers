...
public class LoginServiceIMPL implements LoginService{
	...
	public String loginAdmin(AdminDTO admin)throws AdminException {
      ...
      Admin existingUser = admindao.findByAdminUsername(admin.getAdminUsername());
		...
		java.util.Optional<CurrentUserSession> validCustomerSessionOpt = logrepo.findById(existingUser.getAdminId());
	...
	public String logoutAdmin(String key) throws AdminException {
		...
		CurrentUserSession validCustomerSession = logrepo.findByUuid(key);
		...
		logrepo.delete(validCustomerSession);
